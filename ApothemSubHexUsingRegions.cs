...
//╚═╝  ╚═╝╚══════╝ ╚═════╝ ╚═╝ ╚═════╝ ╚═╝  ╚═══╝╚══════╝ 
	...
	public class ApothemSubHexUsingRegions : GH_Component
	{
		/// <summary>
		/// Initializes a new instance of the MyComponent1 class.
		/// </summary>
		public ApothemSubHexUsingRegions()
			: base(
						"Apothem Hex Subdivision Using Regions",
						"ApothemSubHexUsingRegions",
						"Subdivides the hexagons into the smaller ones and the remaining shapes along it's apothem, using the region curves to select their centroids.",
						"Tortoise",
						"Subdivision"
						)
		{
						...
						if (PointInsideRegionValidator.isPointInsideCurves(centroidPoint, regionCurves))
						{
							...
							switch (polylineType)
							{
								case PolygonIdentifier.PolygonFragmentType.Hexagon:
									...
									List<GH_Curve> HexagonSubdivisionFragments = Subdivision.Hexagon.apothemSubdivision(currentPolyline, hexagonsAlongApothem);
									...
									break;
								case PolygonIdentifier.PolygonFragmentType.EquilateralTriangle:

									//List<GH_Curve> HexagonSubdivisionFragments = Subdivision
									break;
								default:
									break;
							}
